...
import { Mic, MicOff, Send, TrendingUp, Droplet, Moon, Award, MessageCircle, User, LogOut } from 'lucide-react';
...
): { text: string; updatedData?: Partial<HealthData> } => {
...
export default function HealthCompanion() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const SpeechRecognition = (window as unknown as Record<string, new () => ISpeechRecognition>)['SpeechRecognition'] || 
